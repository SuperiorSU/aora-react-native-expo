      ...
      <ScrollView>
        <View className="px-4 w-full min-h-[82vh] justify-center my-6">
          ...
          <FormField
            ...
            handleTextChange={(e)=>setFormData({...formData, username:e})}
          ...
          <View className="justify-center pt-5 gap-2 flex-row">
              <Text className="text-lg text-gray-100 font-gbook">Have an account already?</Text>
              <Link className='text-secondary-100 font-gmedium text-lg' href='/signIn'>
                Sign In 
              </Link>
          </View>
        </View>
